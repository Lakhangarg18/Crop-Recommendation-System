...
import useWeatherForecast from "../customhook/useWeatherForcast"; // Import the new custom hook
...
import WeatherForecast from "./WeatherForecast"; // Import the new component
...
function Weather() {
  ...
  return (
    <div className=" p-3 md:p-10 md:py-20 bg-gradient-to-b to-green-300 from-green-100 dark:from-green-200 dark:to-green-800 bg-cover bg-center">
      <div className="flex flex-wrap w-full h-full dark:bg-opacity-50 rounded-2xl dark:bg-green-100 bg-green-500 bg-opacity-50">
